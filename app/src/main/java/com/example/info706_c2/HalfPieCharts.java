...
public class HalfPieCharts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_pie_charts);
...
//        chart.setHighlightPerTapEnabled(true);
        ...
        try{
            ...
            ResultSet rs = stmt.executeQuery("select * from v_result");
            int i = 0;
            while(rs.next()){
...
//            colors.add(c);
        colors.add(Color.rgb(165,255,145));
        colors.add(Color.rgb(255,75,65));
        colors.add(Color.rgb(255,255,145));
